    ...
    if(step === STEPS.INFO){
        bodyContent = (
          <div className="flex flex-col gap-8">
            ...
            <Counter
              title="Rooms"
              subtitle="How many rooms do your place have?"
              value={roomCount}
            ...
            <Counter
              title="Bathrooms"
              subtitle="How many bathroom do your place have?"
              value={bathroomCount}
        ...
        bodyContent = (
            <div className='flex flex-col gap-8' >
                <Heading 
                    ...
                    subtitle='Guests love photos. Add a few that show what your place is like!'
                />
                <ImageUpload 
                    value={imageSrc}
